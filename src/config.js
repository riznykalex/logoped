...
export const CONFIG = {
  ...
  classify: {
    ...
    rejectDist: 0.5, // матч гірший за це (0..1) → тримаємо попередній стан (без NEUTRAL посеред вправи)
    marginDist: 0.08, // 2-й кандидат ближчий за це до кращого → NEUTRAL/попередній стан (LEFT/RIGHT розв'язуються по cx)
  },
