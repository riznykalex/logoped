...
export const CONFIG = {
  ...
  flappy: {
    gravity: 1500, // прискорення падіння, px/с²
    flapVel: 420, // імпульс маху (будь-який напрямок язика), px/с
    pipeSpeed: 140, // швидкість труб, px/с
    gap: 170, // прохід між верхньою та нижньою трубою, px
    spacing: 230, // крок між трубами, px
