...
export const CONFIG = {
  ...
  // Гра: малювання (drawing.js) — з'єднання точок у стилі редактора
  drawing: {
    cursorSpeed: 120, // швидкість курсора, px/с
    snapRadius: 40, // магніт: на цій відстані курсор прилипає до точки
    visitRadius: 34, // радіус зарахування точки
  },

  // Гра: flappy bird (flappy.js) — нескінченна, без перемоги
  // Пташка ширяє низько над землею (hoverAbove), UP/DOWN змінюють висоту,
  // LEFT гальмує майже до зупинки, RIGHT прискорює. Старт повільний.
  flappy: {
    startSpeed: 55, // повільний старт, px/с
    maxSpeed: 160, // верхня межа швидкості труб
    minSpeed: 8, // LEFT майже зупиняє гру
    accel: 90, // RIGHT: прискорення, px/с²
    decel: 140, // LEFT: гальмування, px/с²
    rampPerPipe: 3, // природне пришвидшення за пройдену трубу, px/с
    climbSpeed: 170, // вертикальна швидкість UP/DOWN, px/с
    hoverAbove: 70, // висота ширяння над землею, px
    spring: 9, // сила повернення до рівня ширяння, 1/с
    damp: 0.92, // гасіння коливань ширяння
    gap: 200, // прохід між верхньою та нижньою трубою, px
    spacing: 240, // крок між трубами, px
